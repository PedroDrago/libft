...
#    Updated: 2023/12/10 12:32:48 by pdrago           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
BONUS_SRC = ft_lstadd_back.c ft_lstadd_front.c ft_lstclear.c ft_lstdelone.c ft_lstiter.c ft_lstlast.c ft_lstmap.c ft_lstnew.c ft_lstsize.c ft_newnode.c
...
fclean: clean
	@rm -f $(NAME)
so:
	cc -nostartfiles -fPIC $(FLAGS) $(SRC) $(BONUS_SRC)
